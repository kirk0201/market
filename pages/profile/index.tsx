        ...
        <div className="flex justify-around py-4 mb-8">
          <Link href={"/profile/sold"}>
            <a className="flex flex-col items-center">
              <div className="flex justify-center border w-12 h-12 items-center rounded-full bg-blue-400 text-white">
                <svg
                  className="w-6 h-6"
                  fill="none"
                  stroke="currentColor"
              ...
              <span className="text-xs mt-1 font-semibold">판매내역</span>
            </a>
          </Link>
          <Link href={"/profile/bought"}>
            <a className="flex flex-col items-center">
              ...
              <span className="text-xs mt-1 font-semibold">구매내역</span>
            </a>
          </Link>
          <Link href={"/profile/favorite"}>
            <div className="flex flex-col items-center cursor-pointer">
              ...
              <span className="text-xs mt-1 font-semibold">관심목록</span>
            </div>
          </Link>
        </div>
        {/* 리뷰 */}
