    ...
    <div className="mt-16 px-4">
      ...
      <div className="mt-8">
        <div className="text-center">
          ...
          <div className="grid grid-cols-2 gap-16 mt-4 border-b ">
            <button
              className={cls(
                "pb-4 ",
                method === "email"
        ...
        <form className="flex flex-col">
          ...
          <button className="font-bold text-sm bg-blue-400 text-white py-2 mt-6 rounded-md border-transparent shadow-sm focus:outline-none hover:bg-blue-600 focus:ring-2 focus:ring-offset-2 focus:ring-blue-400">
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-2 mt-6 gap-4">
            <button className="flex items-center justify-center border py-2 rounded-md bg-gray-100 hover:bg-gray-300 shadow-md">
              <svg
                className="w-5 h-5"
                aria-hidden="true"
                fill="currentColor"
